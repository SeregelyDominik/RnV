...
target_style_feats_path = r"C:\testingstuff\mhuberttest\processed\szindbad\sliced-pt-mhubert147"
knnvc_topk = 4
lambda_rate = 1. #Path(r"C:\testingstuff\rythmmodeloutput\lacidiz\0_global_urhythmic_model.pth")
source_rhythm_model = Path(r"D:\testingstuff\bme\HungarianDysartriaDatabase\lsa.tmit.bme.hu\samples\models\10\20_global_urhythmic_model.pth") # ensure these correspond to the chosen rhythm model type
target_rhythm_model = Path(r"D:\testingstuff\bme\HungarianDysartriaDatabase\lsa.tmit.bme.hu\samples\models\szindbad\20_global_urhythmic_model.pth")

# Load wav and extract features
for file in os.listdir(r"D:\testingstuff\bme\HungarianDysartriaDatabase\lsa.tmit.bme.hu\samples\commands\010_p"):
    source_wav_path = r"D:\testingstuff\bme\HungarianDysartriaDatabase\lsa.tmit.bme.hu\samples\commands\010_p\\"+file
    ...
    output_path = r"testmhub\wavs\\" + str(file)
