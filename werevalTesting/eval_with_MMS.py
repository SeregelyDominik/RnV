...
import params
from utils import load_dataset_for_ASR_without_prepare_for_mms
...
dataset_testds = load_dataset_for_ASR_without_prepare_for_mms(args.dataset, params.TEST_DYSARTHRIC_SPEAKERS, args.wav_dir, True)
...
with open(output_file, mode='w', newline='', encoding='utf-8') as f:
    ...
    for idx, test_record in enumerate(dataset_testds):
        ...
        audio_array, orig_sr = sf.read(audio_path)
